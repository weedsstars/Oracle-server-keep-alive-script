...
bandwidth() {
  ...
  #curl -L https://github.com/weedsstars/Oracle-server-keep-alive-script/-/raw/main/bandwidth_occupier.timer -o bandwidth_occupier.timer && chmod +x bandwidth_occupier.timer
  wget -N https://raw.githubusercontent.com/weedsstars/Oracle-server-keep-alive-script/main/bandwidth_occupier.timer && chmod +x bandwidth_occupier.timer
